...
var myURL = "http://localhost:3000/products";
var productList = document.querySelector('.productsList');
var modifyField = document.querySelector('.modifyBackground');
var modifyWindow = document.querySelector('.modifyWindow');
var modifyDone = document.querySelector('#modificationDone');
...
var exactNameFilter = document.querySelector("#exactNameFilter");
...
var iconRadio = icon.querySelectorAll('input');

modifyField.addEventListener("click", function (e) {
...
modifyDone.addEventListener('click', function (e) {
    e.preventDefault;
    modifyObject(modifyID);
});

categoryFilter.addEventListener('keyup', function (e) {
    var products = document.querySelectorAll('.productsList>div');
...
exactNameFilter.addEventListener('keyup', function (e) {
    var products = document.querySelectorAll('.productsList>div');
    products.forEach(function (el) {
...
function insertProducts(products) {
    ...
    var deleteBtns = document.querySelectorAll('input[name="delete"]');
    ...
    var commentBtns = document.querySelectorAll('input[name="comment"]');
    commentBtns.forEach(function (el, i) {
        el.addEventListener('click', function (e) {
            e.preventDefault;
            var userComment = window.prompt("Write you comment...");
            addComment(userComment, e.target.parentElement.id);
        });
    });
    var modifyBtns = document.querySelectorAll('input[name="modify"]');
    modifyBtns.forEach(function (el, i) {
        el.addEventListener('click', function (e) {
            e.preventDefault;
...
var deleteProduct = function deleteProduct(el) {
    $.ajax({
        url: myURL + "/" + el,
        dataType: 'json',
        method: 'DELETE'
...
var addComment = function addComment(comm, el) {
